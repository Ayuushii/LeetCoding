...
## Difficulty: Easy | Accuracy: 73.31% | Points: 1

## Topics
**Doubly Linked List, Linked List, Data Structures**

## Problem
[Problem Link](https://www.geeksforgeeks.org/problems/display-doubly-linked-list--154650/0)

<p><span style="font-size: 14pt;">Given a doubly linked list of n elements. The task is to&nbsp;return the doubly linked list as an array.</span></p>
...
<p><span style="font-size: 14pt;"><strong>Constraints:</strong><br>1 &lt;= number of nodes &lt;= 10<sup>3</sup><br>0 &lt;= value of nodes &lt;= 10<sup>3</sup></span></p>
