...
## Difficulty: Easy | Accuracy: 54.24% | Points: 1

## Topics
**Algorithms**

## Problem
[Problem Link](https://www.geeksforgeeks.org/problems/square-pattern/0)

<p><span style="font-size: 18px;">Geek is very fond of patterns. Once, his teacher gave him a&nbsp;square pattern to solve. He gave Geek&nbsp;an integer n and asked him to build a pattern.</span></p>
